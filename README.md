...
控制器数据流如下图所示，控制信息由上位机通过串口下发到底层控制器MCU。控制器中的分发器将控制数据分配到相应的控制任务上，各个控制任务获得的数据存于一个消息盒子里面，然在下一次控制时发送回上位机。

![image-20210217142234273](README.assets/image-20210217142234273.png)
